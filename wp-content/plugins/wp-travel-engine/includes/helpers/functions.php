...
function wte_trip_get_trip_rest_metadata( $trip_id ) {
	...
	foreach ( array( 'code' => array( 'key' => 'trip_settings.trip_code', 'type' => 'string', ), 'price' => array( 'key' => 'display_price', 'type' => 'number', ), 'has_sale' => array( 'key' => 'on_sale', 'type' => 'boolean', ), 'sale_price' => array( 'key' => 'sale_price', 'type' => 'number', ), 'discount_percent' => array( 'key' => 'discount_percent', 'type' => 'number', 'decimal' => 0, ), 'currency' => array( 'type' => 'array', 'items' => array( 'code' => array( 'key' => 'code', 'type' => 'string', ), 'symbol' => array( 'key' => 'currency', 'type' => 'string', ), ), ), 'duration' => array( 'type' => 'array', 'items' => array( 'days' => array( 'key' => 'trip_duration', 'type' => 'number', ), 'nights' => array( 'key' => 'trip_duration_nights', 'type' => 'number', ), 'duration_unit' => array( 'key' => 'trip_duration_unit', 'type' => 'string', ), 'duration_type' => array( 'key' => 'set_duration_type', 'type' => 'string', ), ), ), ) as $property_name => $args ) {
	...
	if ( isset( $lowest_package->{'package-categories'} ) && $primary_category_id ) {
		...
		foreach ( array( 'prices' => 'price', 'labels' => 'label', 'pricing_types' => 'pricing_type', 'enabled_sale' => 'has_sale', 'sale_prices' => 'sale_price', 'min_paxes' => 'min_pax', 'max_paxes' => 'max_pax', ) as $source => $key ) {
